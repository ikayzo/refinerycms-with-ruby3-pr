  ...
  module Dragonfly
    module ExtensionConfiguration
      ...
      config_accessor :dragonfly_allow_legacy_urls, :dragonfly_analysers,
                      ...
                      :dragonfly_secret, :dragonfly_url_format, :dragonfly_url_host, :dragonfly_url_path_prefix, :dragonfly_url_segment,
        ...
        def dragonfly_datastore_root_path
          config.dragonfly_datastore_root_path.presence || Rails.root.join('public', 'system', 'refinery', 'images').to_s if Rails.root
        end
        ...
        def dragonfly_url_format
          config.dragonfly_url_format || Refinery::Dragonfly.url_format(config.dragonfly_url_segment)
        end
        ...
        def dragonfly_url_segment
          config.dragonfly_url_segment || config.dragonfly_name.to_s.remove('refinery_')
        end

        def dragonfly_verify_urls
          config.dragonfly_verify_urls || Refinery::Dragonfly.verify_urls
        end
