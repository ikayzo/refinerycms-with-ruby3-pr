...
shared_examples_for 'an image index' do |initial_path|
  ...
  describe 'pagination', unless: Refinery::Image.count<=2 do
    ...
    # paging = Refinery::Image.count > Refinery::Images.pages_per_admin_index
...
#
  ...
  # it 'shows the image upload dialog', js: true do
    # expect(host_element).to have_selector dialog_element_selector
  # end
#
...
#
    # it 'uses supplied title and alt fields', js: true do
      ...
      # expect(Refinery::Image.where(image_title: 'Image Title', image_alt: 'Image Alt')).to exist
    # end
#
    # it 'reports success' do
       # expect(host_element).to have_content(::I18n.t('created', scope: 'refinery.crudify', what: "'Image With Dashes'"))
    # end
  # end
#
