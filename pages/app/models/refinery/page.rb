  ...
  class Page < Core::BaseModel
    ...
    class << self
      ...
      def find_by_path_or_id(path, id)
        Pages::Find.by_path_or_id(path, id)
      end
      ...
      def by_slug(slug, conditions={})
        Pages::Find.by_slug(slug, conditions)
      end
      ...
      def with_globalize(conditions = {})
        Pages::Find.with_globalize(conditions)
      end
